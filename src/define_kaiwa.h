...
#define HYOUJOUSHURUISUU 10
#define MAXKAIWANINZUU 8//会話に参加できる最大人数
#define AISUU 708//id0～32767のうちのAIの数、若い番号の方から採番する0～707が力士のAIのidで力士IDと一致
#define KENSAKUHOJISUU 3//検索用の序列化データのの保持数
...
struct ai_data{
	...
	char type;//0→あなたの言葉、1→力士言葉タイプ、２→男言葉タイプ、3→女言葉タイプなど
